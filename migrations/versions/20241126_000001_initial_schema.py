...
def upgrade() -> None:
    ...
    op.create_index('ix_loans_patron_id_status', 'loans', ['patron_id', 'status'], unique=False)
    op.create_index('ix_loans_catalog_book_id_status', 'loans', ['catalog_book_id', 'status'], unique=False)
    op.create_index('ix_loans_status_due_date', 'loans', ['status', 'due_date'], unique=False)
    ...
    op.create_index(op.f('ix_patrons_is_suspended'), 'patrons', ['is_suspended'], unique=False)
    op.create_index(op.f('ix_patrons_membership_tier'), 'patrons', ['membership_tier'], unique=False)


def downgrade() -> None:
    # Patrons
    op.drop_index(op.f('ix_patrons_membership_tier'), table_name='patrons')
    op.drop_index(op.f('ix_patrons_is_suspended'), table_name='patrons')
    ...
    # Loans
    op.execute("DROP INDEX IF EXISTS ix_loans_active_book_unique")
    op.drop_index('ix_loans_status_due_date', table_name='loans')
    op.drop_index('ix_loans_catalog_book_id_status', table_name='loans')
    op.drop_index('ix_loans_patron_id_status', table_name='loans')
